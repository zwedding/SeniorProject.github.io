<<<<<<< HEAD
// API Key
const apiKey = '-D4CdQPZDAhFqF6GPCXICFK0g6iZdPgFJeg2168RKe-GNO5m8ATa-_smD9XOLsvQXiY8-Af4mBhwdbAcE7Gq9LYBDixAVki8F3eY67tDWwxEwucqbMmU8SpCZqjZZ3Yx';
...
if (searchBookBtn) {
    searchBookBtn.addEventListener('click', function (event) {
        event.preventDefault();
        console.log("Book search button clicked"); // Debugging log
...
if (searchNarrowBtn) {
    ...
    console.error('Search button for the narrow page not found!');
>>>>>>> c0c36d66fd90392a920d800eda73c8f66d5b1439
}